...
from PyQt5.QtCore import (QCoreApplication, QMetaObject, QRect, QSize, Qt, QPropertyAnimation)
from PyQt5.QtGui import (QBrush, QColor, QFont,
                         QIcon, QPalette)
from PyQt5.QtWidgets import *

from chats import Chats
from movealerts import PriceAlerts
from portofolio import Portofolio
from settings import Settings
from traderoom import TradeRoom
...
class BaseWindow(QMainWindow):
    def __init__(self):
        ...
        self.page_porto = Portofolio()
        self.page_news = NewsList()
        self.page_chats = Chats()
        self.page_move = PriceAlerts()
        self.page_tutorials = Tutorials()
        self.page_settings = Settings()
        self.stackedWidget.addWidget(self.page_news)
        self.stackedWidget.addWidget(self.page_chats)
        self.stackedWidget.addWidget(self.page_move)
        self.stackedWidget.addWidget(self.page_tutorials)
        self.stackedWidget.addWidget(self.page_settings)
        self.stackedWidget.addWidget(self.page_porto)
        self.page_home = TradeRoom(self)
        self.page_home.setObjectName(u"page_home")
    ...
    def retranslateUi(self, BaseWindow):
        ...
        self.label_credits.setText(
            QCoreApplication.translate("MainWindow", u"Registered by: Benjamin Gates", None))
...
class MainWindow(BaseWindow):
    def __init__(self):
        ...
        self.setWindowTitle('Fiat Broker - Python Automated Trading Bot')
        UIFunctions.labelTitle(self, 'Fiat Broker - Python Automated Trading Bot')
        ...
        UIFunctions.addNewMenu(self, "Trading view", "btn_trading", "url(icons/16x16/cil-chart.png)", True)
        UIFunctions.addNewMenu(self, "Market News & Analysis", "btn_market", "url(icons/16x16/cil-home.png)", True)
        UIFunctions.addNewMenu(self, "Portofolio", "btn_porto", "url(icons/16x16/cil-user-follow.png)", True)
        UIFunctions.addNewMenu(self, "Move & Alerts", "btn_move", "url(icons/16x16/cil-home.png)", True)
        UIFunctions.addNewMenu(self, "Vidéos tutorials", "btn_videos", "url(icons/16x16/cil-user-follow.png)", True)
        UIFunctions.addNewMenu(self, "Chats", "btn_chats", "url(icons/16x16/cil-equalizer.png)", False)
        UIFunctions.addNewMenu(self, "Settings", "btn_settings", "url(icons/16x16/cil-equalizer.png)", False)

        UIFunctions.selectStandardMenu(self, "btn_trading")

        self.stackedWidget.setCurrentWidget(self.page_home)

        UIFunctions.userIcon(self, "FB", "", True)
    ...
    def Button(self):
        ...
        # PAGE HOME
        if btnWidget.objectName() == "btn_trading":
            self.stackedWidget.setCurrentWidget(self.page_home)
            UIFunctions.resetStyle(self, "btn_trading")
            UIFunctions.labelPage(self, "Trading view")
            btnWidget.setStyleSheet(UIFunctions.selectMenu(btnWidget.styleSheet()))

        # PAGE NEW USER
        if btnWidget.objectName() == "btn_market":
            self.stackedWidget.setCurrentWidget(self.page_news)
            UIFunctions.resetStyle(self, "btn_market")
            UIFunctions.labelPage(self, "Market Analysis")
            btnWidget.setStyleSheet(UIFunctions.selectMenu(btnWidget.styleSheet()))

        # PAGE WIDGETS
        if btnWidget.objectName() == "btn_porto":
            self.stackedWidget.setCurrentWidget(self.page_porto)
            UIFunctions.resetStyle(self, "btn_porto")
            UIFunctions.labelPage(self, "Portefollio")
            btnWidget.setStyleSheet(UIFunctions.selectMenu(btnWidget.styleSheet()))

        # PAGE WIDGETS
        if btnWidget.objectName() == "btn_move":
            self.stackedWidget.setCurrentWidget(self.page_move)
            UIFunctions.resetStyle(self, "btn_move")
            UIFunctions.labelPage(self, "Price Alerts")
            btnWidget.setStyleSheet(UIFunctions.selectMenu(btnWidget.styleSheet()))

        # PAGE WIDGETS
        if btnWidget.objectName() == "btn_videos":
            self.stackedWidget.setCurrentWidget(self.page_tutorials)
            UIFunctions.resetStyle(self, "btn_videos")
            UIFunctions.labelPage(self, "Vidéos tutorials")
            btnWidget.setStyleSheet(UIFunctions.selectMenu(btnWidget.styleSheet()))

        # PAGE WIDGETS
        if btnWidget.objectName() == "btn_chats":
            self.stackedWidget.setCurrentWidget(self.page_chats)
            UIFunctions.resetStyle(self, "btn_charts")
            UIFunctions.labelPage(self, "Chats")
            btnWidget.setStyleSheet(UIFunctions.selectMenu(btnWidget.styleSheet()))
...
class UIFunctions(MainWindow):
    ...
    def maximize_restore(self):
        ...
        if status == 0:
            ...
            self.btn_maximize_restore.setIcon(QIcon('icons/16x16/cil-window-restore.png'))
            ...
            self.btn_maximize_restore.setIcon(QIcon('icons/16x16/cil-window-maximize.png'))
